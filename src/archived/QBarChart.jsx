...
//   backgroundImageTitle = "background image legend",
...
//   const effectiveUseLinearGradient = useLinearGradient === "true" || useLinearGradient === true;
//   const effectiveUseRadialGradient = useRadialGradient === "true" || useRadialGradient === true;
...
//     effectiveUseLinearGradientForeground || effectiveUseRadialGradientForeground;
...
//   const effectiveBoxShadow = boxShadowColor
//     ? `${boxShadowOffsetX}px ${boxShadowOffsetY}px ${boxShadowBlurRadius}px ${boxShadowSpreadRadius}px ${boxShadowColor}`
//     : undefined;
...
//             {effectiveShowXGrid && xTicks.map((x) => (
//               <line
//                 key={`gx-${x}`}
//                 x1={scaleX(x)}
//                 y1={padding}
...
//             {effectiveShowYGrid && data.data.map((_, i) => (
//               <line
//                 key={`gy-${i}`}
//                 x1={padding}
//                 y1={scaleY(i)}
...
//             {/* X labels */}
//             {effectiveShowXlabel && xTicks.map((x) => (
//               <text
//                 key={`tx-${x}`}
//                 x={scaleX(x)}
...
//             {/* Y labels */}
//             {effectiveShowYlabel && data.data.map((p, i) => (
//               <text
//                 key={`ty-${p.y}`}
//                 x={padding - 10}
//                 y={scaleY(i) + 4}
...
//   useLinearGradient: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(['true', 'false'])]),
