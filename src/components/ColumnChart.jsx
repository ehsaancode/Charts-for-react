...
export default function ColumnChartTest() {
  ...
  const fullHeights = useMemo(() => data.map((d) => height - padding - scaleY(d.y)), [data, height, padding, yMin, yMax]);
    ...
    <div className="flex flex-col items-center mt-20">
      <svg width={width} height={height} className="bg-white">
        ...
        {data.map((p, i) => {
          ...
          const barY = height - padding - animatedHeight;
          ...
          return (
            <g key={i}>
              <rect
                ...
                rx={5}
                style={{
                  transition: 'y 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55), height 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)'
                }}
