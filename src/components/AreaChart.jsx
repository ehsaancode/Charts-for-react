...
//   const areaD = createSmoothPath(data);
//   const curveD = createCurvePath(data);

//   useEffect(() => {
//     const linePath = linePathRef.current;
//     const clipRect = clipRectRef.current;
//     if (linePath && clipRect) {
...
export default function AreaChart({
  ...
  backgroundImageUrl = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1064",
